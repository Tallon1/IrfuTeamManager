namespace IrfuTeamManager.Migrations.Identity
{
    using IrfuTeamManager.Models;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<IrfuTeamManager.Models.ApplicationDbContext>
    {
